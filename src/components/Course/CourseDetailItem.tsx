...
const CourseDetailItem: React.FC<IProps> = ({ content }) => {
        ...
        <div>
            <CourseDetailItemContainerStyled onClick={handleClick} isActive={isActive}>
                <div className="content">
                    ...
                    <span className="floatRight"> {content?.contentNumber} bài học</span>
                </div>
            </CourseDetailItemContainerStyled>
            {isActive && (
                <>
                    {content?.hideContent.map((cont) => (
                        <CourseDetailItemHide>
                            ...
                            <span className="floatRight">{cont.length}</span>
                        </CourseDetailItemHide>
                    ))}
                </>
            )}
